jQuery( function ( $ ) {
	// Enable paddle sandbox mode if required.
	if (
		null != paddle_data.sandbox_enabled &&
		'yes' === paddle_data.sandbox_enabled
	) {
	...
	function getSignedCheckoutUrlViaAjax() {
		jQuery.ajax( {
			...
			error: function ( jqxhr, status ) {
				...
				alert(
					'We were unable to process your order, please try again in a few minutes.'
				);
			},
		} );
	}
	...
	function startPaddleCheckoutOverlay(
		checkoutUrl,
		emailAddress,
		country,
		postCode
